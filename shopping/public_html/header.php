...
<div class="header__inner">
  <nav>
    <ul>
      ...
      <li><a href="<?= SITE_URL; ?>/product_list.html">商品一覧</a></li>
      <li><a href="<?= SITE_URL; ?>/cart_list.html">カート内商品</a></li>
      <li><a href="<?= SITE_URL; ?>/admin_products.html">商品情報管理</a></li>
      <li><a href="<?= SITE_URL; ?>/admin_users.html">ユーザー情報管理</a></li>
      <?php } else { ?>
        <li class="user-btn"><a href="<?= SITE_URL; ?>/login.html">ログイン</a></li>
        <li><a href="<?= SITE_URL; ?>/signup.html">ユーザー登録</a></li>
      <?php } ?>
    </ul>
  </nav>
  <div class="header-r">
